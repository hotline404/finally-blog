...
export const mixtureStyle = {
  base_note: `${size.width.base_note} ${size.height.base_note} ${position.base_note} ${color.outline.base_note}`,
  ...
  titleBox: `${position.titleBox} ${size.width.titleBox} ${size.height.titleBox} ${size.font.title} ${color.fontColor.base_note} cursor-pointer select-none`,
  searchBox: `${size.width.searchBox} ${size.height.searchBox} ${position.searchBox} ${outline.searchBox} `,
  postListBox: `${size.width.postListBox} ${size.height.postListBox} ${size.font.postListBox} ${position.postListBox} ${outline.postListBox} ` ,
  postList: `${size.width.postList} ${size.height.postList} ${position.postList} ${outline.postList} ${shadow.postList} ${size.font.postList} ${hover.point.list} ${color.fontColor.base_note} ${overFlow.scrolly} ${overFlow.webkit_track_hide}`,
};
